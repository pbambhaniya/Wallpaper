 ...
 */
public class Love_ImageFragment extends Fragment implements ItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_love_image, container, false);
        context = getActivity();
        shared = new Shared(context);
        rv_img = (RecyclerView) view.findViewById(R.id.rv_img);
        list = new ArrayList<>();
        wallpaper_id = getArguments().getString("id");
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    shared.putString(Config.img, jsonArray.toString());
                    ...
                    adapter.setClickListener(Love_ImageFragment.this);
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                try {
                    ...
                    main.put("wp_category_id", wallpaper_id);
                    main.put("device_id", a_id);
                    param = main.toString();
                } catch (JSONException e) {
                    e.printStackTrace();
                }
